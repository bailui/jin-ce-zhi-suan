...
class DataFactory:
    ...
    使用说明:
    1. 实例化 DataFactory，指定数据源类型 ('tushare', 'akshare', 'binance', 'mysql', 'default')。
...
__all__ = ['DataFactory', 'TushareProvider', 'AkshareProvider', 'BinanceProvider', 'MysqlProvider', 'PostgresProvider', 'DataProvider']
